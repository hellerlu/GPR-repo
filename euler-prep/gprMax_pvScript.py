...
filepath_server = "./GPR_repo/input_files/3D_cylinders_clean_geom.vti"
# filepath_loc = "./GPR_repo/3D_cylinders_clean_geom.vti"

screenshot_name = "3D_cylinders_clean.png"
...
for file in files:
    ...
    with open(filepath_server) as f:
        #######################
        # Read data from file #
        #######################
...
pMLboundaryregion = FindSource('PML boundary region')
